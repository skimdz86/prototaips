...
namespace TalkingPaper.Administration
{
    public partial class TaggaGrigliaForm : FormSchema
    {
        ...
        {
            HelpFormSchema helpForm = new HelpFormSchema("Per essere sicuri che il lettore RFID funzioni a dovere, basta controllare che sia collegato, che la luce verde sia accesa e la luce rossa lampeggi. \nNel caso non funzionasse, ritornare alla pagina di benvenuto e seguire le istruzioni. \nL'espressione \"assegnare un tag\" significa avvicinare il lettore a uno dei tag in modo che possa leggerlo. Quando il tag sarà stato letto, apparira un codice nella casella selezionata.");
